...
import { DUMMY_CLASSES, DUMMY_TEACHERS } from '../data/dummy';
    ...
    <div className="space-y-8 animate-in pb-20">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
           ...
           <h1 className="text-3xl font-bold text-white tracking-tight italic leading-none uppercase">Classes</h1>
           <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px] mt-2 italic">Academic Year 2023-24 &middot; Active Classes: 42</p>
        </div>
        ...
        {DUMMY_CLASSES.map((cls, i) => {
          ...
          return (
            <motion.div
              ...
              key={cls.id}
            >
              <Card onClick={() => navigate(`/admin/classes/${cls.id}`)} className="p-6 group hover:border-indigo-500/30 transition-all cursor-pointer relative overflow-hidden flex flex-col h-full">
                ...
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="text-right">
                    <span className="text-2xl font-black text-white tracking-tighter italic leading-none">{cls.attendance_rate}%</span>
                ...
                <div className="mb-6 flex-1">
                  <h3 className="text-xl font-bold text-white italic tracking-tight mb-2 group-hover:text-indigo-400 transition-colors">{cls.name}</h3>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-bold text-slate-300 italic">{cls.room}</span>
                  </div>
                  <div className="flex items-center gap-2 text-right justify-end">
                    <Clock size={14} className="text-indigo-500/70" />
                    <span className="text-[11px] font-bold text-slate-300 italic">{cls.schedule}</span>
                  </div>
                </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-8 border-t border-slate-800/50">
        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest italic">
          Showing <span className="text-white">6</span> of <span className="text-white">42</span> total classes
        </p>
